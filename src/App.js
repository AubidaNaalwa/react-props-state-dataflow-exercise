...
class App extends Component {
  ...
  generateCompanyTags(companies) {
    ...
    for (let c of companies) {
      companyTags.push(<Company name={c.name} revenue={c.revenue} key={c.name}/>)
    }
    return companyTags
  }
      ...
      <div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-1">
            {companies.map(v => <Company name={v.name} revenue ={v.revenue} key={v.name}/>)}
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-7">
            <Register register = {this.state.reservations} />
            <Calendar calendar = {this.state.reservations} />
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="ex-2">
            <Landing user = {{user:this.state.user , item :this.state.store.find(v => v.hottest)}}/>
            <hr></hr>
